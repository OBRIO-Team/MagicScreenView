...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MagicScreenView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/SerhiiMatvieiev/MagicScreenView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'SerhiiMatvieiev' => 'serhii.matvieiev@gen.tech' }
  s.source           = { :git => 'https://github.com/SerhiiMatvieiev/MagicScreenView.git', :tag => s.version.to_s }
